...
import './RepaireServicesSection.css'
    ...
    <div>
        ...
        <div className="container">
            <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h2 className="mb-5 text-primary text-uppercase">// Explore Car Repaire Services //</h2>
            </div>
...
export default RepaireServicesSection